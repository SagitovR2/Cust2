...
public class Sprite {
    ...
    public void mirrorBitmap() {
        Matrix m = new Matrix();
        m.postScale(-1, 1, this.bitmap.getWidth() / 2f, this.bitmap.getHeight() / 2f);
        Bitmap n = Bitmap.createBitmap(this.bitmap, 0, 0, this.bitmap.getWidth(), this.bitmap.getHeight(), m, true);
        this.bitmap = n;
    }
